...
public class DbInisializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User>userManager)
    {
        var users = new List<User>
        {
            new() {DisplayName = "Andri", UserName = "andri@gmail.com", Email = "andri@gmail.com"},
            new() {DisplayName = "Kucing", UserName = "kucing@gmail.com", Email = "kucing@gmail.com"},
